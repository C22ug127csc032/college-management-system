...
import { protect, financeStaff, adminOnly } from '../middleware/auth.middleware.js';

const router = express.Router();

router.get('/dashboard',  protect,            c.getDashboard);
router.get('/fees',       protect, financeStaff, c.getFeesReport);
router.get('/payments',   protect, financeStaff, c.getPaymentReport);
router.get('/expenses',   protect, financeStaff, c.getExpenseReport);
