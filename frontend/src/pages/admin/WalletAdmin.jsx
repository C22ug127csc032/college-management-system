...
import { FiUser, FiArrowUp, FiArrowDown, FiCreditCard } from '../../components/common/icons';
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-4 pb-4
                ...
                <div className="w-10 h-10 rounded-xl bg-primary-100
                  text-primary-700 font-bold flex items-center justify-center">
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-500
                rounded-xl p-4 text-white mb-4">
